        ...
        <div>
            <Container>
                ...
                <HeaderNavItem>
                    <SignOption>
                        <HeaderOption >
                            <PersonIcon onMouseEnter={handleOpen} onClick={handleOpen} />
                        </HeaderOption>
                        <OptionLineOne onMouseEnter={handleOpen} onClick={handleOpen}>
                            <div className="dropdown">
                                <OptionLineOne >{userData.name}</OptionLineOne>
                                {open ? (
                                    <ul className="menu">
